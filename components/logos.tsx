...
const LinkedinLogo = ({ className }: LogoProps) => {
  return (
    <svg
...
const GithubLogo = ({ className }: LogoProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
...
const PytorchLogo = ({ className }: LogoProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="64"
...
export { LinkedinLogo, GithubLogo, PytorchLogo };
